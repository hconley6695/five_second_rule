...
var Choices = function Choices(three_words) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.grid-container .cell p a.stacktwo').on('click', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.callout').empty();
  next_card(full_stack2);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.grid-container .cell p a.stackthree').on('click', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.callout').empty();
  next_card(full_stack3);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.grid-container .cell p a.stackfour').on('click', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.callout').empty();
...
module.exports = __webpack_require__(/*! /Users/hlconley/Sites/5_Second_Rule/src/assets/js/app.js */"./src/assets/js/app.js");
